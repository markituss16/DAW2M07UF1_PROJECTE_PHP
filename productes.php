...
/*
    public function modificarProducte(){
        $producte=$_POST["nom"].":".$_POST["codi"].":".$_POST["descripcio"].":".$_POST["preu"].":".$_POST["imatge"].":"."\r\n";
        $fitxer_productes = "productes.txt";
        $fitxer = fopen($fitxer_productes,"a") or die ("No s'ha pogut afegir un nou usuari a la llista d'usuaris de web");
